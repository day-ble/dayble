...
import static com.dayble.blog.global.exception.ErrorCodes.CRAWLING_PARSE_ERROR;
import static com.dayble.blog.global.exception.ErrorCodes.GPT_SERVICE_ERROR;
import static com.dayble.blog.global.exception.ErrorCodes.INVALID_NEWS_CONTENT;
...
import com.dayble.blog.news.controller.request.CreateNewsRequest;
...
public class NewsService {
    ...
    public News processNews(String link) {
        try {
            ...
            if (thumbnail.isEmpty()) {
                ...
                throw new DaybleApplicationException(INVALID_NEWS_CONTENT);
            }
            ...
            throw new DaybleApplicationException(CRAWLING_PARSE_ERROR);
        }
    }
    ...
    public void updateNewsSummary(News news, String content) {
        try {
            ...
            throw new DaybleApplicationException(GPT_SERVICE_ERROR);
        }
    }
