...
import static com.dayble.blog.blog.domain.QBlog.blog;
...
public class CustomBlogRepositoryImpl implements CustomBlogRepository {
    ...
    @Override
    public Page<AdminBlogResponse> findBlogByCondition(BlogStatus status, Interest interest, LocalDate startAt,
                                                       LocalDate endAt, Pageable pageable) {
