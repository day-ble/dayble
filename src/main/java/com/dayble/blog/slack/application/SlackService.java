package com.dayble.blog.slack.application;

import static com.dayble.blog.global.exception.ErrorCodes.SLACK_PARSE_ERROR;
    ...
    public void postInquiry(String receiver) {
        try {
            ...
            if (!response.isOk()) {
                ...
                throw new DaybleApplicationException(SLACK_PARSE_ERROR);
            }
        } catch (Exception e) {
